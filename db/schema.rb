...
ActiveRecord::Schema.define(version: 20_160_515_224_036) do
  ...
  add_index 'movies_people', %w(movie_id person_id), name: 'index_movies_people_on_movie_id_and_person_id', using: :btree
  add_index 'movies_people', %w(person_id movie_id), name: 'index_movies_people_on_person_id_and_movie_id', using: :btree
